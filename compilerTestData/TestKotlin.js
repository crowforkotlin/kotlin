...
(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    globalThis.TestKotlin = factory(typeof TestKotlin === 'undefined' ? {} : TestKotlin);
}(function (_) {
  'use strict';
  ...
  initMetadataForClass(Test, 'Test', Test);
  //endregion
  function Annotation() {
  }
  ...
  function readResolve_1($this) {
    ...
    while (inductionVariable < last) {
      ...
      inductionVariable = inductionVariable + 1 | 0;
      // Inline function 'kotlin.coroutines.Serialized.readResolve.stub_for_inlining' call
  ...
  protoOf(Test).test_w5z8la_k$ = function () {
    println('Test');
  };
